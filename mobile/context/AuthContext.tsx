...
const PUBLIC_SEGMENTS = new Set(['login', 'registro', 'sin-acceso', 'perfil-incompleto', 'cuenta-inactiva']);
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (state.session && state.canMobile && state.gate === 'ok' && isPublic && (root === 'login' || root === 'registro')) {
      router.replace('/(tabs)');
    }
...
export type AuthContextValue = AuthState & { refresh: () => Promise<void> };
